      ...
      <template v-slot:default="props">
        <v-row justify="center" align="center" style="width: 100%">
          <v-col
            ...
            lg="3"
          >
            <certificate-presentation v-bind="item"></certificate-presentation>
          </v-col>
        </v-row>
      </template>
...
<script>
import CertificatePresentation from "~/components/CertificatePresentation.vue";
export default {
  components: { CertificatePresentation },
  data: () => ({
